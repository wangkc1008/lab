...
filename1 = './data_1.csv'
filename2 = './data_2.csv'
filename3 = './data_3.csv'
filename3_label = './data_3_label.csv'
filename4 = './data_4.csv'
filename4_label = './data_4_label.csv'
filename_total_origin = './total_origin.csv'
...
class FileProcess:
    ...
    def label_processing(self):
        ...
        label_set = chart_data[['itemid','label']].drop_duplicates()
        print(label_set)
        print(len(label_set))
        ...
        lab_label_set = lab_data[['itemid','label']].drop_duplicates()
        print(lab_label_set)
    ...
    def data_process(self):
        ...
        for i in range(lab_data.shape[0]):
            ...
            # 正则匹配寻找value中的数字
            match = pattern.findall(lab_data.iat[i, 3])
            if match:
                new_value = match
            else:
                new_value = lab_data.iat[i, 3]
            new_res.at[lab_data.iat[i, 0], lab_data.iat[i, 2]] = new_value
